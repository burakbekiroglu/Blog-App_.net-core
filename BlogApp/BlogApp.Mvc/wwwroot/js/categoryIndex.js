                            ...
                            if (categoryListDto.ResultStatus === 0) {
                                ...
                                $.each(categoryListDto.Categories.$values, function (index, category) {
                                    tableBody += `<tr>
                                                            ...
                                                            <td>
                                                            <button class="btn btn-primary btn-sm btn-block"><span class="fas fa-edit"></span> Düzenle</button>
                        ...
                        const newTableRow = `
                                <tr>
                                                    ...
                                                    <td>${categoryAddAjaxModel.CategoryDto.Category.ModifiedByName}</td>
                                                     <td>
                                                     <button class="btn btn-primary btn-block btn-sm"><span class="fas fa-edit"></span> Düzenle</button>
